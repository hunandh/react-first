...
class UserProfile extends React.Component{
	...
	render() {
		return (
			<div>
				{this.props.bio.avatar_url && <li className="list-group-item"> <img src={this.props.bio.avatar_url} className="image-thumb"/></li>}			
				...
				{this.props.bio.locaiton && <li className="list-group-item">Location: {this.props.bio.location}</li>}
